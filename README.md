This is an attempt to get v2 dev server working in Blue Stack.
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create blue-stack-v2-22f1
  fly apps create blue-stack-v2-22f1-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blue-stack-v2-22f1
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app blue-stack-v2-22f1-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'blue-stack-v2-22f1-staging' does not match app name in config file 'blue-stack-v2-22f1'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name blue-stack-v2-22f1-db
  fly postgres attach --app blue-stack-v2-22f1 blue-stack-v2-22f1-db

  fly postgres create --name blue-stack-v2-22f1-staging-db
  fly postgres attach --app blue-stack-v2-22f1-staging blue-stack-v2-22f1-staging-db
  ```
